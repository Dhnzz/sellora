    ...
    <div class="modal fade" id="modalTambah" tabindex="-1" aria-labelledby="modalTambahLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.master_data.product_unit.store') }}" method="POST"
    ...
    <script>
        ...
        $(document).ready(function() {
            dataTable = $('#table').DataTable({
                ...
                ajax: {
                    url: "{{ route('admin.master_data.product_unit.data') }}", // Endpoint API untuk DataTables
                    type: 'GET',
            ...
            $(document).on('click', '.delete-btn', function(e) {
                ...
                var deleteUrl = "{{ route('admin.master_data.product_unit.destroy', ':id') }}";
            ...
            $(document).on('click', '.edit-btn', function(e) {
                var id = $(this).data('id');
                var editUrl = "{{ route('admin.master_data.product_unit.edit', ':id') }}";
                ...
                var updateUrl = "{{ route('admin.master_data.product_unit.update', ':id') }}/";
