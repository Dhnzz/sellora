    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex justify-content-end align-items-start g-2 w-full">
                <a href="{{ route('owner.user_management.customer.create') }}" class="btn btn-sm btn-success">
                    <i class="ti ti-plus"></i> &nbsp; Tambah customer
                </a>
            </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            dataTable = $('#table').DataTable({
                ...
                ajax: {
                    url: "{{ route('owner.user_management.customer.data') }}", // Endpoint API untuk DataTables
                    type: 'GET',
            ...
            $(document).on('click', '.delete-btn', function(e) {
                ...
                var deleteUrl = "{{ route('owner.user_management.customer.destroy', ':id') }}";
                deleteUrl = deleteUrl.replace(':id', customerId);
