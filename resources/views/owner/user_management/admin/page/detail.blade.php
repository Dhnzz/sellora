                ...
                <div class="row g-4">
                    <div class="col-lg-5">
                        <div class="item rounded overflow-hidden">
                            ...
                            @else
                                <img src="{{ asset('storage/' . $admin->photo) }}" alt="" class="img-fluid">
                            @endif
                        </div>
                    </div>
                    <div class="col-lg-7">
                        <div class="shop-content">
                            <div class="d-flex align-items-center gap-2 mb-2">
                                <span class="fs-2 fw-bolder">Admin</span>
                            </div>

                            <h4 class="fw-semibold">{{ $admin->name ?? '' }}</h4>
                            ...
                            <div class="border-top border-bottom py-3 row">
                                <div class="col-12">
                                    <div class="row row-cols-2 row-cols-md-3 mb-3 mb-md-1">
                                        ...
                                        <p class="col-12 col-md-6">{{ $admin->user->email }}</p>
                                    </div>
                                    <div class="row row-cols-2 row-cols-md-3 mb-3 mb-md-1">
                                        <p class="col-6 col-md-3 fw-bolder">Nomor Telepon</p>
                                        <p class="col-auto col-md-1">:</p>
                                        <p class="col-12 col-md-6">{{ $admin->phone }}</p>
                                    </div>
                                    <div class="row row-cols-2 row-cols-md-3 mb-3 mb-md-1">
                                        <p class="col-6 col-md-3 fw-bolder">Alamat</p>
                                        <p class="col-auto col-md-1">:</p>
                                        <p class="col-12 col-md-6">{{ $admin->address }}</p>
                                    </div>
                                    <div class="row row-cols-2 row-cols-md-3 mb-3 mb-md-1">
                                        <p class="col-6 col-md-3 fw-bolder">Didaftarkan Pada</p>
                                        <p class="col-auto col-md-1">:</p>
                                        <p class="col-12 col-md-6">
                                            {{ \Carbon\Carbon::parse($admin->created_at)->format('d M Y, H:i:s') }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex flex-column flex-md-row gap-2 mt-3">
                            <a href="{{ route('owner.user_management.admin.edit', $admin->id) }}" class="btn btn-warning">
                                <i class="ti ti-pencil"></i> Edit Admin
                            </a>
                            <form action="{{ route('owner.user_management.admin.destroy', $admin->id) }}" method="post"
                                class="d-inline">
                                @csrf
                                @method('delete')
                                <button type="submit" class="btn btn-danger w-100"
                                    onclick="return confirm('Apakah Anda yakin ingin menghapus admin ini? Tindakan ini tidak dapat dibatalkan!')">
