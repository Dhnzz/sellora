...
@section('content')
    ...
    <div class="card">
        <form action="{{ route('owner.user_management.sales.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <h5 class="mb-3">Tambah Agen Sales</h5>
                <div class="row">
                    <div class="col-12">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" name="password"
                                ...
                                value="{{ old('password') }}" />
                            <small>*Jika kosong maka password akan otomatis diisi : admin123</small>
                            @error('password')
                                <small class="invalid-feedback">
                                    {{ $message }}
                                </small>
