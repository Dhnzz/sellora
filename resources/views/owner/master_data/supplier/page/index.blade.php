    ...
    <script>
        ...
        $(document).ready(function() {
            dataTable = $('#table').DataTable({
                ...
                ajax: {
                    url: "{{ route('owner.master_data.supplier.data') }}", // Endpoint API untuk DataTables
                    type: 'GET',
            ...
            $(document).on('click', '.delete-btn', function(e) {
                ...
                var deleteUrl = "{{ route('owner.master_data.supplier.destroy', ':id') }}";
            ...
            $(document).on('click', '.edit-btn', function(e) {
                var id = $(this).data('id');
                var editUrl = "{{ route('owner.master_data.supplier.edit', ':id') }}";
                ...
                var updateUrl = "{{ route('owner.master_data.supplier.update', ':id') }}/";
